...
public class MerchantServer : NSObject {
    ...
    public class func createPreference(merchantBaseUrl : String, preferenceUri : String, preference : CheckoutPreference, success: (checkoutPreference: CheckoutPreference) -> Void, failure: ((error: NSError) -> Void)?) {
        
        let service : MerchantService = MerchantService(baseURL: merchantBaseUrl, preferenceUri: preferenceUri)
