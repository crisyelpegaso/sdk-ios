...
public class MerchantServer : NSObject {
    ...
    public class func createPreference(merchantBaseUrl : String, merchantPreferenceUri : String, preference : MerchantPreference, success: (checkoutPreference: CheckoutPreference) -> Void, failure: ((error: NSError) -> Void)?) {
        
        let service : MerchantService = MerchantService(baseURL: merchantBaseUrl, createPreferenceUri: merchantPreferenceUri)
